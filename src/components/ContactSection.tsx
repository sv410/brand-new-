...
const socialLinks = [
  { name: 'LinkedIn', href: 'https://www.linkedin.com/in/srivanivinnakota4/' },
  { name: 'GitHub', href: 'https://github.com/sv410' },
];
    ...
    >
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="mb-16">
          ...
          <a
            href="mailto:srivanivinnakotamadhava@gmail.com"
            className="animate-in inline-flex items-center gap-4 text-xl md:text-2xl text-muted-foreground hover:text-foreground transition-colors group break-all md:break-normal"
            data-cursor-hover
          >
            <Mail className="w-6 h-6" />
            <span className="relative">
              srivanivinnakotamadhava@gmail.com
        ...
        <div className="animate-in pt-12 border-t border-border">
          ...
          <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} Srivani Vinnakota. All rights reserved.
            </p>
            <p className="text-sm text-muted-foreground">
